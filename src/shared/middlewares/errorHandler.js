...
const productionMessages = {
  ...
  PAYMENT_PROVIDER_MISMATCH: 'Payment verification did not match this checkout. No order was created.',
  PAYMENT_SESSION_LIMIT: 'Too many active payment sessions. Resume or abandon an earlier checkout first.',
  PAYMENT_ABANDON_NOT_ALLOWED: 'This payment may already be in progress and cannot be abandoned safely.',
  PAYMENT_NOT_VERIFIED: 'Payment is not verified yet. Reconcile the payment before placing the order.',
  PAYMENT_SNAPSHOT_MISSING: 'This captured payment cannot be fulfilled safely and will be refunded.',
  PAYMENT_REFUND_INITIATED: 'The paid order could not be fulfilled. A full refund has been initiated.',
  TOTP_REQUIRED: 'Owner authenticator code required.',
  TOTP_INVALID: 'Owner authenticator code is invalid.',
  ADMIN_ASSIGNMENT_EXPIRED: 'Administrator assignment has expired.',
  ADMIN_ACTION_TOKEN_INVALID: 'This setup or reset link is invalid or expired.',
  SECURITY_EMAIL_UNAVAILABLE: 'Security email delivery is unavailable.',
